...
Sibling docs: [PRD.md](PRD.md) · [FEATURES.md](FEATURES.md) · [DESIGN.md](DESIGN.md) · [TASKS.md](TASKS.md) · [stages/](stages/) · [AGENT-WORKFLOW.md](AGENT-WORKFLOW.md) · root [README](../README.md)
...
sibling doc (the **Owner** column) and assembled for execution in a per-stage file
([`stages/`](stages/)). When this catalog and an owning doc disagree, **the owning
...
### Stage 1 — MVP menu-bar palette · [stage file](stages/STAGE-1-mvp-palette.md)
...
### Stage 2 — Prompt store + CRUD · [stage file](stages/STAGE-2-prompt-store-crud.md)

| Feature | Owner | Notes |
|---------|-------|-------|
| In-app add/edit/delete writing the same markdown files | TASKS Stage 2, PRD §8 | No DB. Pulled when hand-editing gets annoying. |

### Stage 3 — Static tokens · [stage file](stages/STAGE-3-static-tokens.md)
...
### Stage 4 — `{{ask:label}}` inline expansion · [stage file](stages/STAGE-4-ask-inline-expansion.md)
...
### Stage 5 — Inverse capture · [stage file](stages/STAGE-5-inverse-capture.md)
...
### Stage 6 — Frecency + search · [stage file](stages/STAGE-6-frecency-search.md)
...
### Stage 7 — Adaptive ⌥1–9 HUD row · [stage file](stages/STAGE-7-adaptive-hud-row.md)
